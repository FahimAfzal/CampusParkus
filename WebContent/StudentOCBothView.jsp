...
<body>
	...
	<form action="StudentServlet" method="post">
    	<input type="hidden" name="LoadStudentValue" value="OCBEV" />
    	<input id="mySubmit" type="submit" value="Yes" />
    </form><br>
    <form action="StudentServlet" method="post">
    	<input type="hidden" name="LoadStudentValue" value="OCBNoEV" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StudentOCBList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StudentOCBMap" />
