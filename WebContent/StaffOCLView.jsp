...
<body>
	...
	<form action="StaffServlet" method="post">
    	<input type="hidden" name="LoadStaffValue" value="OCLEV" />
    	<input id="mySubmit" type="submit" value="Yes" />
    </form><br>
    <form action="StaffServlet" method="post">
    	<input type="hidden" name="LoadStaffValue" value="OCLNoEV" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StaffOCLList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StaffOCLMap" />
