...
<body>
	...
	<form action="StaffServlet" method="post">
    	<input type="hidden" name="LoadStaffValue" value="OCSEV" />
    	<input id="mySubmit" type="submit" value="Yes" />
    </form><br>
    <form action="StaffServlet" method="post">
    	<input type="hidden" name="LoadStaffValue" value="OCSNoEV" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StaffOCSList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StaffOCSMap" />
