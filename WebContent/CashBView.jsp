...
<body>
	...
	<form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CashBEV" />
    	<input id="mySubmit" type="submit" value="Yes" />
    </form><br>
    <form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CashBNoEV" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="CashBList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="CashBMap" />
