...
<body>
	...
	<form action="StudentServlet" method="post">
    	<input type="hidden" name="LoadStudentValue" value="OCStructure" />
    	<input id="mySubmit" type="submit" value="Parking Structure" />
    </form><br>
    <form action="StudentServlet" method="post">
    	<input type="hidden" name="LoadStudentValue" value="OCLot" />
    	<input id="mySubmit" type="submit" value="Parking Lot" />
    </form><br>
    <form action="StudentServlet" method="post">
    	<input type="hidden" name="LoadStudentValue" value="OCBoth" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StudentOCList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="StudentOCMap" />
