...
<body>
	...
	<form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CCStructure" />
    	<input id="mySubmit" type="submit" value="Parking Structure" />
    </form><br>
    <form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CCLot" />
    	<input id="mySubmit" type="submit" value="Parking Lot" />
    </form><br>
    <form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CCBoth" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="VCreditList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="VCreditMap" />
