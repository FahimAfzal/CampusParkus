...
<body>
	...
	<form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CashLEV" />
    	<input id="mySubmit" type="submit" value="Yes" />
    </form><br>
    <form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CashLNoEV" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="CashLList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="CashLMap" />
