...
<body>
	...
	<form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="Credit" />
    	<input id="mySubmit" type="submit" value="Credit Card" />
    </form><br>
    <form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="Cash" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="VisitorList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="VisitorMap" />
