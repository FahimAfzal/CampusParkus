...
<body>
	...
	<form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CCSEV" />
    	<input id="mySubmit" type="submit" value="Yes" />
    </form><br>
    <form action="VisitorServlet" method="post">
    	<input type="hidden" name="LoadVisitorValue" value="CCSNoEV" />
    ...
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="VCCSList" />
    	<input id="mySubmit" type="submit" value="View List" />
    </form><br>
    <form action="MapListServlet" method="post">
    	<input type="hidden" name="LoadMapValue" value="VCCSMap" />
